...
%===================== 定理类环境 ==========================
%例题环境
\newcounter{myexmcounter}
\setcounter{myexmcounter}{0}
\numberwithin{myexmcounter}{section}
\newcommand{\myexmindent}{0em}
\renewcommand{\themyexmcounter}{\arabic{section}.\arabic{myexmcounter}}
\newcommand{\myexmfont}{\normalsize\rmfamily\bfseries}
\newcommand{\myexmlabel}
{
    \hspace{\myexmindent}
    \fcolorbox{cyan}{cyan}
        {\myexmfont{}例题\hspace{0.5em}\themyexmcounter}
}
\newenvironment{myexm}[1]
    {
        \refstepcounter{myexmcounter}
        \par\vspace{0ex}
        \noindent
        \rule[0.3ex]{16cm}{0.8pt}
        \par\noindent\myexmlabel\hspace{0.3em}\mbox{\myexmfont{}#1}
        \kaishu\par
    }
